/* 避免无限递归循环 */
import { activeEffect } from '../5-嵌套的effect与effect栈/1-effect-fn-reg.js'
...
function trigger(target, key)
{
  ...
  effects.forEach(ef =>
  {
    if (ef === activeEffect) return //当前副作用既依赖此状态，又更改了此状态
    ef()
  })
  console.log({
    target,
    key,
    effects: effects && [...effects].map(ef => ef.fnId)
  })
}

...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      '@jetjo/vue3/reactive/*.js': './exports-barrel/reactive/*.js',
      '@jetjo/vue3/effect/*.js': './exports-barrel/effect/*.js',
      '@jetjo/vue3/computed/*.js': './exports-barrel/computed/*.js',
      '@jetjo/vue3/watch/*.js': './exports-barrel/watch/*.js',
      '@jetjo/vue3/ref/*': './exports-barrel/reactive/ref/*.js',
      '@jetjo/vue3/reactive/*': './exports-barrel/reactive/*.js',
      '@jetjo/vue3/effect/*': './exports-barrel/effect/*.js',
      '@jetjo/vue3/computed/*': './exports-barrel/computed/*.js',
      '@jetjo/vue3/watch/*': './exports-barrel/watch/*.js',
      '@jetjo/vue3/ref': './exports-barrel/reactive/ref/6-1.js',
      '@jetjo/vue3/reactive': './exports-barrel/reactive/5-8.js',
      '@jetjo/vue3/effect': './exports-barrel/effect/4-11.js',
      '@jetjo/vue3/computed': './exports-barrel/computed/4-11.js',
      '@jetjo/vue3/watch': './exports-barrel/watch/4-11.js'
    },
    exclude: [
      '**/node_modules/**',
      '_*/**',
